    ...
    >
      ...
      <template v-slot:toolbar_buttons>
        <el-form :inline="true">
          ...
          <el-form-item v-permission="['base-data:supplier:modify']">
      ...
      <template v-slot:action_default="{ row }">
        <el-button v-permission="['base-data:supplier:query']" type="text" icon="el-icon-view" @click="e => { id = row.id;$refs.viewDialog.openDialog() }">查看</el-button>
        <el-button v-permission="['base-data:supplier:modify']" type="text" icon="el-icon-edit" @click="e => { id = row.id;$refs.updateDialog.openDialog() }">修改</el-button>
      </template>
    </vxe-grid>
