<template>
  <div v-permission="['base-data:customer:query']">
      ...
      >
        ...
        <template #toolbar_buttons>
          <a-space>
            ...
            <a-button
              v-permission="['base-data:customer:add']"
              type="primary"
              :icon="h(PlusOutlined)"
            ...
            <a-dropdown>
              ...
              <a-button v-permission="['base-data:customer:delete']">更多<DownOutlined /></a-button>
            </a-dropdown>
          </a-space>
        </template>
    ...
    methods: {
      ...
      createActions(row) {
        return [
          ...
          {
            permission: ['base-data:customer:modify'],
            label: '修改',
            onClick: () => {
              this.id = row.id;
