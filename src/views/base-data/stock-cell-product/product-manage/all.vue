<template>
  ...
  >
    <div v-if="visible" v-permission="['base-data:stock-cell-product:query']" v-loading="loading">
            ...
            <j-border>
              <j-form bordered label-width="80px" @collapse="$refs.grid.refreshColumn()">
                ...
                <j-form-item label="仓位编号">
                  <a-input v-model:value="searchFormData.stockCellCode" allow-clear />
                </j-form-item>
                <j-form-item label="仓位名称">
                  <a-input v-model:value="searchFormData.stockCellName" allow-clear />
                </j-form-item>
      ...
      <!-- 导入 -->
      <stock-cell-product-importer ref="importDialog" @confirm="search" />
...
<script>
  ...
  import StockCellProductImporter from '@/components/Importor/StockCellProductImporter.vue';
