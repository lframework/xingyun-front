    ...
    <div v-loading="loading" v-permission="['base-data:product:info:add']">
      ...
      >
        <vxe-form-group span="24" title="基础信息" title-bold vertical>
          <vxe-form-item :visible="isEmpty(productType)" title="商品类型" span="8">
        ...
        <vxe-form-group v-if="showProductInfoItems" span="24" title="商品图片" title-bold vertical>
          <vxe-form-item
            :visible="showProductInfoItems"
            title="商品主图"
            field="mainImage"
        ...
        <vxe-form-group v-if="showProductInfoItems" span="24" title="SKU信息" title-bold vertical>
          <vxe-form-item
      ...
      <div v-if="showProductInfoItems" class="form-modal-footer">
        <a-space>
