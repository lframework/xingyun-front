<template>
  <el-dialog :visible.sync="visible" :close-on-click-modal="false" append-to-body width="80%" top="5vh" title="属性值管理" @open="open">
      ...
      >
        ...
        <template v-slot:toolbar_buttons>
          <el-form :inline="true">
            ...
            <el-form-item v-permission="['base-data:product:property-item:add']">
        ...
        <template v-slot:action_default="{ row }">
          <el-button v-permission="['base-data:product:property-item:modify']" type="text" icon="el-icon-edit" @click="e => { id = row.id;$refs.updateDialog.openDialog() }">修改</el-button>
        </template>
      </vxe-grid>
