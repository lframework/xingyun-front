  ...
  <div v-if="visible" class="app-container">
    <div v-permission="['settle:pre-sheet:add']" v-loading="loading">
      ...
      <div style="text-align: center;">
        ...
        <el-button v-permission="['settle:pre-sheet:approve']" type="primary" :loading="loading" @click="redirectApprovePassOrder">审核通过</el-button>
  ...
  methods: {
    ...
    redirectApprovePassOrder() {
      ...
      this.$msg.confirm('确定执行审核通过操作？').then(() => {
        this.loading = true
        this.$api.settle.preSheet.redirectApprovePassOrder(params).then(res => {
