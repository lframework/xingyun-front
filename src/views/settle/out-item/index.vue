  ...
  <div v-permission="['settle:out-item:query']" class="app-container">
    ...
    >
      ...
      <template v-slot:action_default="{ row }">
        <el-button v-permission="['settle:out-item:query']" type="text" icon="el-icon-view" @click="e => { id = row.id;$refs.viewDialog.openDialog() }">查看</el-button>
        <el-button v-permission="['settle:out-item:modify']" type="text" icon="el-icon-edit" @click="e => { id = row.id;$refs.updateDialog.openDialog() }">修改</el-button>
      </template>
    </vxe-grid>
