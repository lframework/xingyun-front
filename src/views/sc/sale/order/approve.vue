<template>
  <div v-if="visible" class="app-container">
    <div v-permission="['sale:order:approve']" v-loading="loading">
      ...
      <div v-if="$enums.SALE_ORDER_STATUS.CREATED.equalsCode(formData.status) || $enums.SALE_ORDER_STATUS.APPROVE_REFUSE.equalsCode(formData.status)" style="text-align: center;">
        <el-button v-permission="['sale:order:approve']" type="primary" :loading="loading" @click="approvePassOrder">审核通过</el-button>
        <el-button v-if="$enums.SALE_ORDER_STATUS.CREATED.equalsCode(formData.status)" v-permission="['sale:order:approve']" type="danger" :loading="loading" @click="approveRefuseOrder">审核拒绝</el-button>
