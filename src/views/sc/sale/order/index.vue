<template>
  <div>
    <div v-permission="['sale:order:query']">
        ...
        >
          ...
          <template #toolbar_buttons>
            <a-space>
              ...
              >
              <a-button
                v-permission="['sale:order:export']"
...
<script>
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      // 删除订单
      deleteOrder(row) {
        createConfirm('对选中的销售单据执行删除操作？').then(() => {
          this.loading = true;
          api
            .deleteById(row.id)
            .then(() => {
