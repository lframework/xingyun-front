  ...
  <div v-if="visible" class="app-container">
    <div v-permission="['sale:order:modify']" v-loading="loading">
      ...
      <div style="text-align: center;">
        <el-button v-permission="['sale:order:modify']" type="primary" :loading="loading" @click="updateOrder">保存</el-button>
...
export default {
  ...
  methods: {
    ...
    updateOrder() {
      ...
      this.loading = true
      this.$api.sc.sale.saleOrder.updateOrder(params).then(res => {
