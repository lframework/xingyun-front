  ...
  <div v-if="visible" class="app-container">
    <div v-permission="['sale:return:add']" v-loading="loading">
      ...
      <div style="text-align: center;">
        <el-button v-permission="['sale:return:add']" type="primary" :loading="loading" @click="createOrder">保存</el-button>
        <el-button v-permission="['sale:return:approve']" type="primary" :loading="loading" @click="redirectApprovePassOrder">审核通过</el-button>
  ...
  methods: {
    ...
    redirectApprovePassOrder() {
      ...
      this.$msg.confirm('对销售退货单执行审核通过操作？').then(() => {
        this.loading = true
        this.$api.sc.sale.saleReturn.redirectApprovePassOrder(params).then(res => {
    ...
    beforeSelectSc() {
      ...
      this.$msg.error('由于“销售退货单关联销售出库单”，不允许修改仓库！')
      return false
    },
    beforeSelectCustomer() {
      ...
      this.$msg.error('由于“销售退货单关联销售出库单”，不允许修改客户！')
      return false
    },
    beforeSelectSaler() {
