  ...
  export default defineComponent({
      ...
      return {
        ...
        tableColumn: [
          ...
          { field: 'createBy', title: '操作人', width: 100 },
          {
            ...
            width: 100,
            formatter: ({ cellValue }) => {
              return this.$enums.SALE_OUT_SHEET_STATUS.getDesc(cellValue);
            },
          },
    ...
    methods: {
      ...
      batchDelete() {
        ...
        this.$msg.createConfirm('对选中的销售出库单执行批量删除操作？').then(() => {
          this.loading = true;
          api
      ...
      batchApprovePass() {
        ...
        this.$msg.createConfirm('对选中的销售出库单执行审核通过操作？').then(() => {
          this.loading = true;
          api
            .batchApprovePass({
          ...
          },
          {
            ...
            ifShow: () => {
              return (
                ...
                this.$enums.SALE_OUT_SHEET_STATUS.APPROVE_REFUSE.equalsCode(row.status)
              );
            },
            onClick: () => {
