  ...
  export default defineComponent({
    ...
    methods: {
      ...
      queryProduct(queryString, row) {
        ...
        purchaseApi.searchPurchaseProducts(this.formData.scId, queryString, false).then((res) => {
          row.products = res;
      ...
      createScannedRow(product, receiveNum = 1) {
      ...
      async consumeScanQueue() {
        ...
        try {
          const products = await purchaseApi.searchPurchaseProducts(
            this.formData.scId,
            code,
            false,
          );
