  ...
  <div v-if="visible" class="app-container">
    <div v-permission="['purchase:return:add']" v-loading="loading">
      ...
      >
        ...
        <template v-slot:toolbar_buttons>
          <el-form :inline="true">
            ...
            <el-form-item>
              <el-button @click="batchInputPurchasePrice">批量调整采购价</el-button>
            </el-form-item>
            <el-form-item>
      ...
      <div style="text-align: center;">
        <el-button v-permission="['purchase:return:add']" type="primary" :loading="loading" @click="createOrder">保存</el-button>
        <el-button v-permission="['purchase:return:approve']" type="primary" :loading="loading" @click="redirectApprovePassOrder">审核通过</el-button>
  ...
  methods: {
    ...
    redirectApprovePassOrder() {
      ...
      this.$msg.confirm('对采购退货单执行审核通过操作？').then(() => {
        this.loading = true
        this.$api.sc.purchase.purchaseReturn.redirectApprovePassOrder(params).then(res => {
