<template>
  <div v-permission="['stock:adjust:reason:query']">
      ...
      >
        ...
        <template #toolbar_buttons>
          <a-space>
            ...
            <a-button
              v-permission="['stock:adjust:reason:add']"
              type="primary"
              :icon="h(PlusOutlined)"
            ...
            <a-dropdown>
              ...
              <a-button v-permission="['stock:adjust:reason:delete']"
                >更多<DownOutlined
              /></a-button>
            </a-dropdown>
          </a-space>
...
<script>
  ...
  export default defineComponent({
    ...
    setup() {
      return { h, SearchOutlined, PlusOutlined, CheckOutlined, DeleteOutlined };
    },
    data() {
      return {
        loading: false,
    ...
    methods: {
      ...
      createActions(row) {
        return [
          ...
          {
            permission: ['stock:adjust:reason:modify'],
            label: '修改',
            onClick: () => {
              this.id = row.id;
