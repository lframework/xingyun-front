<template>
  <a-modal v-model="visible" :mask-closable="false" width="75%" title="差异处理" :dialog-style="{ top: '20px' }">
    ...
    <template slot="footer">
      <div class="form-modal-footer">
        <a-space>
          <a-button v-permission="['stock:take:plan:create-diff']" type="primary" :loading="loading" @click="submit">差异处理</a-button>
