<template>
  <div>
    <div v-permission="['customer-settle:check-sheet:query']">
        ...
        >
          ...
          <template #toolbar_buttons>
            <a-space>
              ...
              >
              <a-button
                v-permission="['customer-settle:check-sheet:delete']"
                danger
              ...
              >
              <a-button
                v-permission="['customer-settle:check-sheet:export']"
    ...
    methods: {
      ...
      createActions(row) {
        return [
          ...
          {
            permission: ['customer-settle:check-sheet:approve'],
            label: '审核',
            ifShow: () => {
              return (
          ...
          {
            permission: ['customer-settle:check-sheet:modify'],
            label: '修改',
            ifShow: () => {
              return (
                this.$enums.CUSTOMER_SETTLE_CHECK_SHEET_STATUS.CREATED.equalsCode(row.status) ||
