    ...
    <div v-if="visible" v-permission="['customer-settle:check-sheet:query']" v-loading="loading">
      ...
      >
        ...
        <template #bizCode_default="{ row }">
          <span
            v-show="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.OUT_SHEET.equalsCode(row.bizType)"
          ...
          <span
            v-show="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.SALE_RETURN.equalsCode(row.bizType)"
          ...
          <span
            v-show="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.SETTLE_FEE_SHEET.equalsCode(row.bizType)"
          ...
          <span
            v-show="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.SETTLE_PRE_SHEET.equalsCode(row.bizType)"
