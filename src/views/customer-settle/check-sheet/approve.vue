    ...
    <div v-permission="['customer-settle:check-sheet:approve']" v-loading="loading">
      ...
      >
        ...
        <template #bizCode_default="{ row }">
          <span
            v-if="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.OUT_SHEET.equalsCode(row.bizType)"
          ...
          <span
            v-if="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.SALE_RETURN.equalsCode(row.bizType)"
          ...
          <span
            v-if="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.SETTLE_FEE_SHEET.equalsCode(row.bizType)"
          ...
          <span
            v-if="CUSTOMER_SETTLE_CHECK_SHEET_BIZ_TYPE.SETTLE_PRE_SHEET.equalsCode(row.bizType)"
      ...
      <div
        v-if="
          CUSTOMER_SETTLE_CHECK_SHEET_STATUS.CREATED.equalsCode(formData.status) ||
          CUSTOMER_SETTLE_CHECK_SHEET_STATUS.APPROVE_REFUSE.equalsCode(formData.status)
        "
      ...
      >
        <a-space>
          ...
          >
          <a-button
            v-if="CUSTOMER_SETTLE_CHECK_SHEET_STATUS.CREATED.equalsCode(formData.status)"
            v-permission="['customer-settle:check-sheet:approve']"
            danger
            :loading="loading"
